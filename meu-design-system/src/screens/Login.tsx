        ...
        <div className="w-full max-w-md m-auto px-6 py-12 flex flex-col">
          ...
          <div className="space-y-5">
            ...
            <button 
              ...
              className="w-full py-3.5 bg-brand-500 hover:bg-brand-600 text-white font-semibold rounded-xl transition-colors shadow-sm mt-4"
            >
              Entrar
            </button>
          </div>
          ...
          <div className="space-y-3">
            <button 
              onClick={() => onNavigate('perfil')}
              className="w-full py-3 border border-slate-300 hover:bg-slate-50 text-slate-700 font-medium rounded-xl transition-colors flex items-center justify-center gap-3"
            >
